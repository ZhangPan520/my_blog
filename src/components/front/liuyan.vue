<template>
    <div id='comment'>
        ...
        <div class='allComments'>
            <div class='summary'>
                <p>
                   <span @click="getLiuyans({role:false})">最早 </span>|
                   <span @click="getLiuyans({sort: 'date',role:false})">最新 </span>|
                </p>
            </div>
...
export default {
    ...
    methods: {
        ...mapActions(['summitLiuyan', 'getLiuyans', 'updateLike']),
