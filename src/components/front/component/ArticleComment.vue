    ...
    <div id='comment'>
        ...
        <div class='allComments'>
            <div class='summary'>
                ...
                <p>
                   <span @click="getAllComments({id: $route.params.id,role:false})">最早 </span>|
                   <span @click="getAllComments({id: $route.params.id, sort: 'date',role:false})">最新 </span>|
                   <span @click="getAllComments({id: $route.params.id, sort: 'like',role:false})"> 最热</span>
                </p>
            </div>
...
export default {
    ...
    created () {
        this.getAllComments({id: this.$route.params.id,role:false})
    ...
    watch: {
        $route (to, from) {
            ...
            this.getAllComments({id: to.params.id,role:false})
        }
    }
}
